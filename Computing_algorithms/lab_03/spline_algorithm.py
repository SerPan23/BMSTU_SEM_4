...
# def spline_three_dimensional_interpolation(data, xp, yp, zp):
#     start = 0
#     end = 0
...
#             y_values.append(Point(y_arr[i], spline(x_values, xp, start, end)))

#         z_values.append(Point(z_arr[k], spline(y_values, yp, start, end)))

#     return spline(z_values, zp, start, end)
