...
static std::vector <pixel_t> wu_x(point_t start, point_t end, double max_intensity)
{
...
static std::vector <pixel_t> wu_y(point_t start, point_t end, double max_intensity)
{
    std::vector<pixel_t> pixels;
